...
<section class="products">
    <h1 class="heading">Sản phẩm {{ $category }}.</h1>
    ...
    <div class="box-container">
        @forelse($products as $product)
            <form action="{{ route('add.to.wishlist.or.cart') }}" method="post" class="box">
                ...
                <img src="{{ asset('storage/' . $product->image_01) }}" alt="" onclick="window.location.href='{{ route('quick.view', ['pid' => $product->id]) }}'; return false;" style="cursor: pointer;">
